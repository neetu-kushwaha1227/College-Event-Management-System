...
$sql="SELECT * FROM signup where username=$un";
...
$r=mysqli_fetch_assoc($result);
  ...
  if(isset($_POST['submit']))
  {
    ...
    $query="UPDATE signup set username='$username',fullname='$fullname',email='$email',course='$cn',sem='$sem',pno='$pno' where username='$un'";
