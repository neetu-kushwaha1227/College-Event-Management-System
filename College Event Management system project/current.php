...
<table border='1' width='100%' style='margin:24px'>
    <tr>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            <tr class="<?php echo $event_class; ?>">
                <td><img src="<?php echo $photo_path ?>" height=89px width=50% style="display:flex; justify-content:center; align-items:center;"></td>
                 <td><?php echo $event_name; ?></td>
                 <td><?php echo $min; ?></td>
                 <td><?php echo $max; ?></td>
                <td><?php echo $event_date; ?></td>
                <td><?php echo $is_past_event ? "Past Event" : "Current Event"; ?></td>
                <td>
